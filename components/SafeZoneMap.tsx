...
const SafeZoneMap = React.memo(function SafeZoneMap({
  ...
  const filteredSafeZones = React.useMemo(() => {
    return safeZones.filter(zone => {
      ...
      if ((zone.security_level || 3) < filters.minSecurityLevel) return false;
      ...
      <div class="p-4 max-w-sm">
        ...
        <div class="space-y-2 mb-4">
          ...
          <div class="flex items-center gap-2 text-xs text-gray-600">
            ...
            <span>Security Level ${safeZone.security_level || 3}/5</span>
          </div>
          ...
          <div class="flex items-center gap-2 text-xs text-gray-600">
            ...
            <span>${safeZone.average_rating ? safeZone.average_rating.toFixed(1) : 'N/A'}/5 (${safeZone.total_reviews || 0} reviews)</span>
          </div>
        </div>
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3 text-xs text-gray-500">
                        <span>Security: {safeZone.security_level || 3}/5</span>
                        <span>★ {safeZone.average_rating ? safeZone.average_rating.toFixed(1) : 'N/A'} ({safeZone.total_reviews || 0})</span>
                      </div>
