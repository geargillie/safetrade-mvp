...
const SafeZoneMap = React.memo(function SafeZoneMap({
  ...
  const filteredSafeZones = React.useMemo(() => {
    return safeZones.filter(zone => {
      ...
      if ((zone.securityLevel || 3) < filters.minSecurityLevel) return false;
      ...
      <div class="p-4 max-w-sm">
        ...
        <div class="space-y-2 mb-4">
          ...
          <div class="flex items-center gap-2 text-xs text-gray-600">
            ...
            <span>Security Level ${safeZone.securityLevel || 3}/5</span>
          </div>
          ...
          <div class="flex items-center gap-2 text-xs text-gray-600">
            ...
            <span>${safeZone.averageRating ? safeZone.averageRating.toFixed(1) : 'N/A'}/5 (${safeZone.totalReviews || 0} reviews)</span>
          </div>
        </div>
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3 text-xs text-gray-500">
                        <span>Security: {safeZone.securityLevel || 3}/5</span>
                        <span>★ {safeZone.averageRating ? safeZone.averageRating.toFixed(1) : 'N/A'} ({safeZone.totalReviews || 0})</span>
                      </div>
