          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-3 text-xs text-gray-500">
                ...
                <span>🔒 Level {safeZone.securityLevel}</span>
                {distance && (
          ...
          <div className="text-center p-3 bg-gray-50 rounded-lg">
            ...
            <div className="flex justify-center">
              {[...Array(5)].map((_, i) => (
                <svg
                  key={i}
                  className={`w-3 h-3 ${i < Math.floor(safeZone.averageRating) ? 'text-yellow-400' : 'text-gray-300'}`}
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
            ...
            <div className="text-xs text-gray-500 mt-1">
              {safeZone.totalReviews} reviews
            </div>
          </div>

          <div className="text-center p-3 bg-gray-50 rounded-lg">
            <div className="text-xl font-bold text-gray-900 mb-1">
              {safeZone.securityLevel}
            </div>
              ...
              {[...Array(5)].map((_, i) => (
                <div
                  ...
                  className={`w-2 h-2 rounded-full ${
                    i < safeZone.securityLevel ? 'bg-blue-500' : 'bg-gray-300'
                  }`}
                />
              ))}
            </div>
