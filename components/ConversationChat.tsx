...
export default function ConversationChat({
      ...
      <div className={`bg-white border border-gray-300 rounded-lg shadow-sm ${className}`}>
        <div className="h-96 flex items-center justify-center">
          <div className="text-center max-w-md px-6">
            ...
            <p className="text-gray-500 text-sm">Choose a conversation from the left to start messaging with buyers or sellers.</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className={`bg-white border border-gray-300 rounded-lg shadow-sm flex flex-col ${className}`}>
      {/* Chat Header */}
