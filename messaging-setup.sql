...
-- 2. CREATE OR FIND CONVERSATION FUNCTION
-- This function creates a new conversation or returns existing one
...
-- This function sends a message and updates conversation timestamp
...
-- This function marks messages as read for a specific user
...
-- 5. CREATE TRIGGER TO UPDATE CONVERSATION TIMESTAMP
-- This ensures conversation.updated_at is always current
